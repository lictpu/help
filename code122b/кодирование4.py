def f4():
    ...
    def pamyat():
        ...
        G=input()
        if G=="0":
            N=input("Мощность алфавита(N)-?\n")
            K=int(input("колво символов в тексте(K)-?\n"))
            I,V=float(input("инф объём текста(I)-?\n")),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            print("i==")
            if N=="":
                otvet(K*perevod(I,V))
            else: 
        ...
        if G=="3":
            ...
            otvet(I)
        if G=="2":
            I,V1=float(input("инф объём текста(I)-?\n")),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            i,V2=input("инф  символа(i)-?\n"),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            N=input("Мощность алфавита(N)-?\n")
            if i=="":
    ...
    def zvuk():
        ...
        G=input()
        if G=="0":
            i,b=float(input("глубина звука(i)-?\n")),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            print("N==")
            print(2**perevod(i,b))
        if G=="1":
            N=input("количество уровней сигнала(N)-?\n")
            i,b1=input("глубина звука(i)-?\n"),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            T=float(input("длительность звукового файла(T)-?\n"))
            V,b2=float(input("объём звуковоо файла(V)-?\n")),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            print("D==")
            if i =="":
        ...
        if G=="2":
            D=float(input("частота дискретизации(D)-?\n"))
            i,b1=input("глубина звука(i)-?\n"),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            N=input("количество уровней сигнала(N)-?\n")
            T=float(input("длительность звукового файла(T)-?\n"))
            print("V==")
    ...
    def isobr():
        ...
        G=input()
        if G=="0":
            i,b1=input("глубина текста(i)-?\n"),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            print("N==")
            print(2**perevod(i,b1))
        if G=="1":
            i,b1=input("глубина текста(i)-?\n"),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            N=input("количество цветов в политре(N)-?\n")
            W=int(input("ширина изображения(W)-?\n"))
            I,b2=float(input("инф объём изобр(ажения(I)-?\n")),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            print("H==")
            if i=="":
        ...
        if G=="2":
            i,b1=input("глубина текста(i)-?\n"),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            N=input("количество цветов в политре(N)-?\n")
            H=int(input("высота изображения(H)-?\n"))
            I,b2=float(input("инф объём изобр(ажения(I)-?\n")),input("в чём данные? \n 0 - бит\n 1 - байт\n 2 - килобайт\n 3 - мегабайт\n 4 - гигабайт\n")
            print("W==")
            if i=="":
